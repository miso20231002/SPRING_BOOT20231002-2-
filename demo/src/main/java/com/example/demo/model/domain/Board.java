...
public class Board {
    ...
    public Board(String title, String content, String count, String likec, String user,String newdate){
    this.title = title;
    ...
    public void update(String title, String content, String count, String likec, String user,String newdate) { // 현재 객체 상태 업데이트
        this.title = title;
        this.content = content;
        this.count=count;
        this.user=user;
